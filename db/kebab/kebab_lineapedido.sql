...
CREATE TABLE `lineapedido` (
  ...
  KEY `fk_lineapedido_pedido1_idx` (`pedido_id`),
  CONSTRAINT `fk_lineapedido_pedido1` FOREIGN KEY (`pedido_id`) REFERENCES `pedido` (`id`)
...
-- Dump completed on 2024-11-26 19:08:25
